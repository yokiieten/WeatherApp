...
public struct AIMConstants {
    ...
    public static let backgroundColor: UIColor = UIColor(red: 0, green: 0, blue: 0, alpha: 0.6)
    ...
    public static var activityIndicatorStyle: UIActivityIndicatorView.Style = .white
